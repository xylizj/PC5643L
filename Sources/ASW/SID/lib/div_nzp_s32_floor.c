 ...
 *   FUNCTIONS
 *****************************************************************************/
SInt32 div_nzp_s32_floor(SInt32 temp_numerator, SInt32 temp_denominator)
{
    return (((temp_numerator < 0) != (temp_denominator < 0)) && (temp_numerator %
             temp_denominator != 0) ? -1 : 0) + temp_numerator /
        temp_denominator;
}
